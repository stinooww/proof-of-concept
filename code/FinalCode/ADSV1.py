...
class ADS():
    ...
    def __init__(self, Ro=10, analogPin=0):
       ...
       # self.adc = Adafruit_ADS1x15.ADS1015() 
        ...
        self.LPGCurve = [1.9,0.275,-0.47]    # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent"
                                            # to the original curve. 
                                            # data format:{ x, y, slope}; point1: (lg200, 0.21), point2: (lg10000, -0.59) 
        self.COCurve = [5.0,1.5,-0.34]     # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg200, 0.72), point2: (lg10000,  0.15)
        self.SmokeCurve =[3.3,0.6,-0.44]   # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
...
#        print(read/self.Ro )
    ...
    def ADSCalibration(self, ads_pin):
	    ...
	    val += float(self.RL_VALUE*(1023.0-read)/float(read))
           # print(val)
